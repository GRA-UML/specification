...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Service Description Keywords Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link gov.ojp.it.gsp.services._1._0.impl.ServiceDescriptionKeywordsTypeImpl#getServiceDependency <em>Service Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ServiceDescriptionKeywordsTypeImpl extends MinimalEObjectImpl.Container implements ServiceDescriptionKeywordsType {
	/**
	 ...
	 * @generated
	 */
	protected ServiceDescriptionKeywordsTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return graPackage.Literals.SERVICE_DESCRIPTION_KEYWORDS_TYPE;
	}
	...
	public EList<ServiceIdentificationType> getServiceDependency() {
		if (serviceDependency == null) {
			serviceDependency = new EObjectContainmentEList<ServiceIdentificationType>(ServiceIdentificationType.class, this, graPackage.SERVICE_DESCRIPTION_KEYWORDS_TYPE__SERVICE_DEPENDENCY);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case graPackage.SERVICE_DESCRIPTION_KEYWORDS_TYPE__SERVICE_DEPENDENCY:
...
} //ServiceDescriptionKeywordsTypeImpl
